            ...
            <Box
                ...
                <Box width="90%">
                    ...
                    <Box
                        ...
                        <Button
                            variant="contained"
                            href={`https://developer.api.autodesk.com/authentication/v2/authorize?response_type=code&client_id=${client_id}&redirect_uri=http://localhost:8080/SelectProject/&scope=data:read%20viewables:read%20data:write%20data:create`}
                            sx={{
                            mt: 2,
                            mb: 3,
                            pt: 1.5,
